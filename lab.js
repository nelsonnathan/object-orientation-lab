...
const cat1 = new Cat('Merlot', 10, 'brown')
...
const gandalf = new Wizard('Dumbledore', 150, 'love')
gandalf.castSpell()
...
//Code Here
const newPhone1 = new Phone('apple', 'iphone', 512, 'black', 1000)
const newPhone2 = new Phone('samsung', 's21', 128, 'white', 1000)
const newPhone3 = new Phone('google', 'pixel', 256, 'blue', 1000)
/* 
...
//Code Here
let myFirstVehicle = new Vehicle(2, 'black', 20000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'grey', 5000, 'BMW', true)
/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myFirstMotorcycle.moveMotorcycle(500)
/*
...
//Code Here
let myFirstBoat = new Boat(10, 'red', 1300, 'BoatyMcBoatface', 'Boston Whaler', false)
/*
